// Command apionly is a small API-only service built out of keel, to be read
// rather than deployed. It is the notes API without the browser UI: the same
// JSON API and auth, no templates, no static assets, no form handlers.
//
